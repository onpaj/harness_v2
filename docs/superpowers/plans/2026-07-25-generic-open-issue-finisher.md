...
**Files:**
- Create: `docs/adr/0022-open-issue-is-a-generic-finisher.md`
...
```bash
git add docs/adr/0022-open-issue-is-a-generic-finisher.md CLAUDE.md README.md docs/
git commit -m "docs: ADR-0022, generic open-issue finisher and data-driven serving"
```
