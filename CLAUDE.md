...
force-checked-out into a second worktree meanwhile is the residual risk. Deliberate — don't "fix" the `--force` away, and don't add worktree cleanup without re-checking this invariant.
